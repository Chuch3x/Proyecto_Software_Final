describe("Menu vista Admin ", () => {
  ...
  it("Debería crear producto", () => {
    ...
    cy.get("#items_menu").should(
      "contain",
      "Choripan: Chorizo en un pan - Precio: $15 - Stock: 10"
    );
  });
  it("Debería eliminar producto", () => {
    ...
    cy.get("#items_menu").should(
      "contain",
      "Hamburguesa: Carne en un pan - Precio: $10 - Stock: 10"
    );
    cy.xpath(
      'id("items_menu")//li[contains(text(),"Hamburguesa")]/following-sibling::button/following-sibling::button'
    ).click();
    cy.get("#items_menu").should(
      "not.have.text",
      "Hamburguesa: Carne en un pan - Precio: $10 - Stock: 10"
